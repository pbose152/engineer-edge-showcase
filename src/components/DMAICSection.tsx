...
const sappiProjects = [
  ...
  },
  {
    ...
    description: "Weekly SQC reports tracking viscosity, coatweight, glycol, and silicone metrics across 3 coating lines using 15-point rolling averages in Minitab.",
    outcome: "Adopted by the UltraCast leadership team for weekly review cadence.",
    tags: ["Quality Metrics", "Executive Reports", "Viscosity / Coatweight / Glycol / Silicone", "Minitab"],
  },
  {
    icon: Users,
