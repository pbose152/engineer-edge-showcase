...
const experiences = [
  {
    ...
    highlights: [
      ...
      "Investigated 17 LSV (Linear String Void) defect events across two coating lines, narrowing failure modes through Pareto analysis and Braincube data pulls; findings informed the corrective action plan owned by the Sappi quality team.",
