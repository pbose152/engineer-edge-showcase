...
const experiences = [
  {
    ...
    highlights: [
      ...
      "Accelerated coating defect investigations by running real-time monitoring on Braincube and PI (Plant Information) System dashboards; turned production data the line was already generating into diagnostic signal during shift handoffs.",
      "Investigated 17 LSV (Linear String Voids) defect events across two coating lines, narrowing failure modes through Pareto analysis and Braincube data pulls; findings informed the corrective action plan owned by the Sappi quality team.",
